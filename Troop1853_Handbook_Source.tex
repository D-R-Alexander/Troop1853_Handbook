...
\begin{titlepage}
    ...
    \vfill
	\begin{figure}
	\subfigure{\includegraphics[scale=0.25]{TroopLogo.jpg}}
	\hfill
	\subfigure{\includegraphics[scale=0.5]{OldMan.jpeg}}
    \vfill
    %\vfill
	\end{figure}
	%April 1, 2023
...
\url{https://www.troopwebhost.org/Troop1853SpringfieldVA///} for the \ac{BT} and \url{https://troopwebhost.org/Troop1853SPRINGFIELD/} or \url{www.troop1853.com} for the \ac{GT}. 
